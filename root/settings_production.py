"""
Django settings for root project - Production configuration for Render.com
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-p+&m-bgwrueucz&(20=t+^q-pkwktz0@n+ias4imqe5h08h0ka')
...
# Email configuration for production (allow override via env)
